...
$$
f(k_x, k_y, k_z) = \sum_{i=1}^{M} c_i \exp(i(k_x x_i + k_y y_i + k_z z_i)), - N_j/2 \leq k_j \leq (N_j - 1)/2 \quad \text{for } j \in \{x, y, z\}
$$
